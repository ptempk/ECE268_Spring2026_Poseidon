...
# ---------------------------------------------------------------------------
# Constants for case_n255_t3
# Source: poseidon_params_n255_t3_alpha5_M128.txt
# Params: n=255, t=3, alpha=5, M=128, R_F=8, R_P=56
# Modulus = prime_255
# Number of round constants: 192  (= t * (R_F + R_P) = 3 * 64)
# ---------------------------------------------------------------------------

round_constants_n255_t3 = [
...
# 3x3 MDS matrix for case_n255_t3
matrix_n255_t3 = [
